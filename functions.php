...
function job_meta_box() {
  add_meta_box('job_details','Job Details','job_meta_callback','jobs');
}
add_action('add_meta_boxes','job_meta_box');

function job_meta_callback($post) {
?>
<p>
<label>Salary</label><br>
<input type="text" name="salary" value="<?php echo get_post_meta($post->ID,'salary',true); ?>">
</p>
<p>
<label>Location</label><br>
<input type="text" name="location" value="<?php echo get_post_meta($post->ID,'location',true); ?>">
</p>
<?php }
